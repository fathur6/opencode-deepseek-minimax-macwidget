...
- [x] 05-01-PLAN.md — Typed display preferences and fixed compact-card layout
- [x] 05-02-PLAN.md — Keychain-first per-provider credential resolution

**Wave 2** *(blocked on Wave 1 completion)*

- [x] 05-03-PLAN.md — Independent collection without display-state coupling
- [x] 05-04-PLAN.md — Native Providers Settings and secure setup interaction
